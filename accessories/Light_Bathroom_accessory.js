...
var light = exports.accessory = new Accessory('Bathroom', lightUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
light.username = "1A:2B:3C:4D:5E:02";
...
light
  .addService(Service.Lightbulb, "BadezimmerLicht") // services exposed to the user should have "names" like "Fake Light" for us
