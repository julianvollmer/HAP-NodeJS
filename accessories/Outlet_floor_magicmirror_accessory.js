...
var OUTLET = {
  ...
  setPowerOn: function(on) { 
    var status = "0";
    var url = 'http://127.0.0.1:3000/outlet/4/'
...
var outlet = exports.accessory = new Accessory('OutletFloorMagicmirror', outletUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
outlet.username = "1A:2B:3C:4D:5E:D0";
...
outlet
  .addService(Service.Outlet, "MagicMirror") // services exposed to the user should have "names" like "Fake Light" for us
